var username, vechiletype, pricedaily, pricemonthly, priceyearly, res;
...
function vechileTypeForm() {
    vechiletype = document.getElementById("vechileType").value;
...
function vechileSummaryForm() {
    ...
    if (vechiletype == "Cycle") {
        ...
        pricemonthly = 100;
        priceyearly = 500;
        document.getElementById("image").src = "cycle.png";
    }
    else if (vechiletype == "MotorCycle") {
        pricedaily = 10;
        pricemonthly = 200;
        priceyearly = 1000;
        document.getElementById("image").src = "motorcycle.jpg";
    }
    else if (vechiletype == "Four Wheeler") {
        pricedaily = 20;
        pricemonthly = 500;
        priceyearly = 3500;
        document.getElementById("image").src = "car.jpg";
    }
...
function converter() {
    res = document.getElementById("priceType").value;
    if (res == "inr") {
